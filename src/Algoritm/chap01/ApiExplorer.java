...
public class ApiExplorer {
    public static void main(String[] args) throws IOException {
        StringBuilder urlBuilder = new StringBuilder("http://apis.data.go.kr/B552555/lhLeaseInfo1/lhLeaseInfo1"); /*URL*/
        ...
        urlBuilder.append("&" + URLEncoder.encode("SPL_TP_CD","UTF-8") + "=" + URLEncoder.encode("07", "UTF-8")); /*공급유형코드*/
